...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'phantomx_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cyril/Documents/uv5.8/Hexabot/workspaceRos/src/phantomx/phantomx_gazebo/${idir}'.  ${_report}")
    endif()
